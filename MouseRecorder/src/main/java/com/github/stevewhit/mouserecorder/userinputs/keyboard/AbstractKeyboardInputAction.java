 ...
 *
 */
public abstract class AbstractKeyboardInputAction extends AbstractInputAction
{
	/**
	...
	/**
	 * Constructor that accepts an int keyvalue and a timestamp.
	 * @param keyValue The key value of the keyboard key.
	 * @param timeStamp The timestamp which this action occurred.
	 * @throws IllegalArgumentException Throws if the keyvalue is invalid or the timestamp is negative.
	 */
	protected AbstractKeyboardInputAction(int keyValue, long timeStamp) throws IllegalArgumentException
	{
		super(timeStamp);
	 ...
	 * {@inheritDoc}
	 * <p>
	 * Also, verifies that the keyboard key value is valid.
	 * </p>
	 */
	@Override
	public boolean isValidAction()
	{
		return super.isValidAction() && keyValue >= 0 && getKeyValueText(keyValue) != null;
	}
	 ...
	 */
	protected static String getKeyValueText(int keyValue)
	{
	 ...
	 * @param keyValue The integer value of the keyboard key.
